...
par.lambda.z_c = 10;
par.lambda.z_uc = 0.1;
par.lambda.h_c = 5; % TODO: should be average overstay penalty in real data, should move to par
par.lambda.h_uc = 5; % TODO: should be average overstay penalty in real data, should move to par
par.mu = 1e4;
